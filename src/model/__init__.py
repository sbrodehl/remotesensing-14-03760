...
def register_normalization_with_defaults(mf_obj, Normalization, overwrite=None, init_normalization=None, additional_args=None):
...
def register(mf):
    ...
    mf.register_event('register_normalization_with_defaults', register_normalization_with_defaults)
