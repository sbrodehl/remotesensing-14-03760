...
class CacheLayer:
    ...
    def contains(self, digest: str, suffix: str = "cache", suffixes: list = None) -> bool:
    ...
    def set_cache(self, digest: str, data: Any, suffix: str = "cache", suffixes: list = None) -> None:
    ...
    def get_cache(self, digest: str, suffix: str = "cache", suffixes: list = None) -> Any:
        ...
        if suffixes is None:
            ...
            suffixes = '.' + '.'.join(suffixes)
        try:
            return torch.load((self.cache_path / f"{digest}{suffixes}.{suffix}"), pickle_module=pickle)
