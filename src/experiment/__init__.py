...
def register(mf):
    ...
    mf.overwrite_globals({
        "sgdw.lr": 0.5,
        "sgdw.weight_decay": 1e-5,
        "onecycle.pct_up": 0.215,
        "onecycle.div_factor": 10.,
        "onecycle.final_div_factor": 100.,
        "optimizer.regularizer_factor": 0.3,
    })
    mf.overwrite_globals({
        "log.batched_data_no": 4,
        "log.every": 8
    })
    mf.overwrite_globals({
        "loader.batchsize": 64,
    ...
    mf.overwrite_globals({
        "sources.SOURCE_channel_tags": [
            "VIS006", "VIS008", "IR_016", "IR_039", "WV_062", "WV_073", "IR_087", "IR_097", "IR_108", "IR_120", "IR_134", "PERSISTENCE",
        ],
        "sources.META_channel_tags": [
            "LAT", "LON", "YEAR", "MONTH", "DAY", "HOUR", "MINUTE",
        ],
        "sources.AUXILIARY_channel_tags": [
            "BT_062", "BT_073"
        ],
    ...
    mf.overwrite_globals({
        "unet.channel_hierarchy_depth": 64,
    })
    mf.overwrite_globals({
        "epochs": 14,
    })
